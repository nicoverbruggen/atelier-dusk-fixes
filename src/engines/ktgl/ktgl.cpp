...
constexpr KtglGame kGames[] = {
  ...
  { "Atelier_Escha_and_Logy.exe",    0x73739c, 0x85e978,
    ...
    0x4c9b30,
    { 0x48, 0x89, 0x5c, 0x24, 0x18, 0x57, 0x48, 0x83,
      0xec, 0x40, 0x48, 0x8b, 0x05, 0x9f, 0xbf, 0xcc },
    0x4c9c50, 0x949450,
    BuildMultilingual },
  { "Atelier_Shallie_EN.exe",        0x6bca4c, 0x76f320,
    0x0c2670, 0x0c28d0, 0xe9b10, 0x5d5170,
    { 0x40, 0x53, 0x48, 0x83, 0xec, 0x20, 0x48, 0x8b,
    ...
    0x477b80,
    { 0x48, 0x89, 0x5c, 0x24, 0x18, 0x57, 0x48, 0x83,
      0xec, 0x40, 0x48, 0x8b, 0x05, 0xff, 0x53, 0x96 },
    0x477c90, 0x8f7fe8,
    BuildEnglish },
  { "Atelier_Shallie.exe",           0x6ff53c, 0x7c89c0,
    0x0c3ec0, 0x0c4120, 0xec0d0, 0x617b60,
    { 0x40, 0x53, 0x48, 0x83, 0xec, 0x20, 0x48, 0x8b,
    ...
    0x4ba990,
    { 0x48, 0x89, 0x5c, 0x24, 0x18, 0x57, 0x48, 0x83,
      0xec, 0x40, 0x48, 0x8b, 0x05, 0x7f, 0x78, 0xc7 },
    0x4baaa0, 0xaab790,
    BuildMultilingual },
};
...
bool initializeKtglFixes() {
  static const bool initialized = [] {
    ...
    // Holds a standing player still on a slope. Two hooks in one transaction,
    // so a partial install cannot leave a flag set that nothing clears. See
    // field_slope_fix.h; it gates itself on its own feature.
    atfix::installFieldSlopeHold(id.base,
      { game->charaUpdateRva, game->charaUpdateExpected,
        game->moveCollideRva, game->moveCollideExpected,
        game->applyDeltaRva, game->brainUserVtableRva });
    return true;
  }();
  return initialized;
}
