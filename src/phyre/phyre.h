...
// (TECHNICAL.md "The engine triage"). That is
...
// recorded in TECHNICAL.md "Hook boundaries"; do not change an RVA here without
// updating it.
//
// atlasUnlockRva names the two-instruction *stub* at lock+0x40, not the
// implementation behind it. Both are mapped (TECHNICAL.md "The unlock has two
